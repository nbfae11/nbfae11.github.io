...
$.fn.initializeGoogleMap = function (options) {
	...
	var mapApiUrl = "//maps.google.ae/maps/api/js?sensor=false&callback=mapApiLoaded&language=ae"; //"//maps.googleapis.com/maps/api/js?sensor=false&callback=mapApiLoaded";
